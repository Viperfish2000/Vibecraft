...
@OnlyIn(Dist.CLIENT)
public class StrawberryBeeModel<T extends StrawberryBeeEntity> extends AgeableModel<T> {
	...
	public StrawberryBeeModel() {
		...
		bone.setRotationPoint(-0.5F, -4.0F, 0.0F);
		body.addChild(bone);
		setRotationAngle(bone, 0.0F, -0.7854F, 0.0F);
		bone.setTextureOffset(0, 30).addBox(0.0F, -7.0F, -5.0F, 0.0F, 7.0F, 10.0F, 0.0F, false);
		bone2 = new ModelRenderer(this);
		bone2.setRotationPoint(-0.5F, -4.0F, 0.0F);
		body.addChild(bone2);
		setRotationAngle(bone2, 0.0F, 0.7854F, 0.0F);
		bone2.setTextureOffset(0, 30).addBox(0.0F, -7.0F, -5.0F, 0.0F, 7.0F, 10.0F, 0.0F, false);
