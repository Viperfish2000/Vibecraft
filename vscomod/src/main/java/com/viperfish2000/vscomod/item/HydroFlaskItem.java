...
public class HydroFlaskItem extends BlockItem {
	   public HydroFlaskItem(Block blockIn, Item.Properties builder) {
	   ...
	   public ItemStack onItemUseFinish(ItemStack stack, World worldIn, LivingEntity entityLiving) {
	      ...
	      return stack.isEmpty() ? new ItemStack(ItemList.cup) : stack;
	   }
