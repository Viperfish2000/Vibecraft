...
import com.viperfish2000.vscomod.client.models.BackpackModel;
...
extends ArmorItem
{
public BackpackItem(IArmorMaterial material, EquipmentSlotType equipmentSlot, Item.Properties properties) { super(material, equipmentSlot, properties); }
...
public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
  ...
  **/ 
    ...
    {
    	BackpackModel model = new BackpackModel(0f, 0, 128, 128);
            //	 A model = _default;
                 
        //      ModelLegs modelLegs = new ModelLegs(0.1f);
            model.bipedBody.showModel = armorSlot == EquipmentSlotType.CHEST || armorSlot == EquipmentSlotType.CHEST;
