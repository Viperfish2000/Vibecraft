...
public class NetItem extends BucketItem {
	   private final EntityType<?> butterflyType;

	   @Deprecated
	   public NetItem(EntityType<?> butterflyTypeIn, Fluid p_i49022_2_, Item.Properties builder) {
	      super(p_i49022_2_, builder);
	      this.butterflyType = butterflyTypeIn;
	      this.butterflyTypeSupplier = () -> butterflyTypeIn;
	   }

	   public NetItem(java.util.function.Supplier<? extends EntityType<?>> butterflyTypeIn, java.util.function.Supplier<? extends Fluid> p_i49022_2_, Item.Properties builder) {
	      super(p_i49022_2_, builder);
	      this.butterflyType = null;
	      this.butterflyTypeSupplier = butterflyTypeIn;
	   }
	   ...
	   private void placeFish(World worldIn, ItemStack p_205357_2_, BlockPos pos) {
	      Entity entity = this.butterflyType.spawn(worldIn, p_205357_2_, (PlayerEntity)null, pos, SpawnReason.BUCKET, true, false);
	     /** if (entity != null) {
	   ...
	   public void addInformation(ItemStack stack, @Nullable World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn) {
	      if (this.butterflyType == EntityRegistry.BUTTERFLY) {
	   ...
	   private final java.util.function.Supplier<? extends EntityType<?>> butterflyTypeSupplier;
	   protected EntityType<?> getbutterflyType() {
	       return butterflyTypeSupplier.get();
	   }
	}