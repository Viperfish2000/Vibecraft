...
import com.viperfish2000.vscomod.client.models.SunglassesModel;
...
{
public SunglassesItem(IArmorMaterial material, EquipmentSlotType equipmentSlot, Item.Properties properties) { super(material, equipmentSlot, properties); }
...
public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
  ...
  **/ 
  ...
  @Override
    ...
    {
		SunglassesModel model = new SunglassesModel(0f, 0, 64, 64);
            //	 A model = _default;
