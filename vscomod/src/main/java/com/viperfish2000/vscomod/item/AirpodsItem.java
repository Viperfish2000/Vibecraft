...
import com.viperfish2000.vscomod.client.models.AirpodsModel;
...
public class AirpodsItem extends ArmorItem
{
public AirpodsItem(IArmorMaterial material, EquipmentSlotType equipmentSlot, Item.Properties properties) { super(material, equipmentSlot, properties); }
...
public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
  ...
  **/ 
  ...
  @Override
    ...
    {
    	AirpodsModel model = new AirpodsModel(0f, 0, 64, 64);
            //	 A model = _default;
                 
        //      ModelLegs modelLegs = new ModelLegs(0.1f);
    		model.bone.showModel = armorSlot == EquipmentSlotType.HEAD;
    		model.bone2.showModel = armorSlot == EquipmentSlotType.HEAD;
