...
import com.viperfish2000.vscomod.client.models.FlowerCrownModel;
...
{
public FlowerCrownItem(IArmorMaterial material, EquipmentSlotType equipmentSlot, Item.Properties properties) { super(material, equipmentSlot, properties); }
...
public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
  ...
  **/ 
  ...
  @Override
    ...
    {
		FlowerCrownModel model = new FlowerCrownModel(0f, 0, 64, 64);
            //	 A model = _default;
