...
import com.viperfish2000.vscomod.client.models.PonytailModel;
...
public class PonytailItem
extends DyeableArmorItem
{
	  public PonytailItem(IArmorMaterial p_i50048_1_, EquipmentSlotType p_i50048_2_, Item.Properties p_i50048_3_) {
...
public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
  ...
  **/ 
  ...
  @Override
    ...
    {
		PonytailModel model = new PonytailModel(0f, 0, 64, 64);
            //	 A model = _default;
