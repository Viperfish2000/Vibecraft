...
extends ArmorItem
{
public NecklaceItem(IArmorMaterial material, EquipmentSlotType equipmentSlot, Item.Properties properties) { super(material, equipmentSlot, properties); }
...
public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
  ...
  **/ 
    ...
    {
    	NecklaceModel model = new NecklaceModel(0f, 0, 32, 32);
            //	 A model = _default;
