...
public class FairyLightsBlock extends Block {
   ...
   public FairyLightsBlock(Block.Properties builder) {
      super(builder);
...
public boolean isReplaceable(BlockState state, BlockItemUseContext useContext) {
   ...
   @Override public boolean isLadder(BlockState state, IWorldReader world, BlockPos pos, net.minecraft.entity.LivingEntity entity) { return false; }
}